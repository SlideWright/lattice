...
// cN-light family per the chart-colour philosophy — same well piechart
// wedges draw from. Pale tint on light canvas, deep hue on dark canvas;
// fills the lane pill and the card's 3px left stripe.
