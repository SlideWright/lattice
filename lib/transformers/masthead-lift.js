 ...
 * the runtime bundle.
 *
 * Three render paths consume this via the registry:
 *   - marp.config.js      — render hook → applyAllToHtml → applyToHtml
...
module.exports = {
  ...
  applyToSection(innerHtml, cls) {
    return { html: engine.transformMastheadSection(innerHtml, cls), cls };
  },
  applyToDom(root) {
