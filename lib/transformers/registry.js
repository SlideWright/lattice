...
// section class. Subsequent transformers (split-panels, roadmap,
// journey, word-cloud, image-scrim, image-asset) operate on disjoint
// section classes, so their relative order doesn't affect correctness
// — but we preserve the historical marp.config.js render-hook order
// to keep cross-renderer parity easy to reason about.
const TRANSFORMERS = [
  chartFamily,
  splitPanels,
  roadmap,
