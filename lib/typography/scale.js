...
const SCALES = {
  ...
  //    Reference: 1080 wide (1cqi = 10.8px). Targets chosen for boardroom
  //    legibility at presentation distance AND to fill a 9:16+ frame; the title
  //    ramp is compressed vs body so a 2-line h1 doesn't overflow.
  portrait: {
    'meta':         2.40,    // ≈26px — labels/pills/eyebrows: glasses-on legible
    'body-compact': 2.75,    // ≈30px
    'body':         3.30,    // ≈36px — prose
    'message':      4.25,    // ≈46px — statement
    'emphasis':     5.35,    // ≈58px
    'h6':           2.40,    // ≈26px
    'h5':           3.30,    // ≈36px
    'h4':           4.05,    // ≈44px
    'h3':           4.60,    // ≈50px
    'h2':           5.55,    // ≈60px — slide title
    'h1':           8.15,    // ≈88px — dominant title (pulled DOWN; fits two lines)
    'hero':        13.00,    // ≈140px — big-number hero
  },
