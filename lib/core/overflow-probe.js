 ...
 * trips the ring). As more frames adopt the contract (Phase 2: `.cell-stage`),
 * they join this selector — the single place the set is maintained.
 */
...
const CLIP_CELL_SELECTOR = '.panel-right, .compare-right';
