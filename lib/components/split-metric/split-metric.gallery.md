...
<!-- _class: split-metric dark -->
<!-- _footer: "Composition: dark · split-metric dark" -->
...
<!-- _class: split-metric compact -->
<!-- _footer: "Composition: compact · split-metric compact" -->
...
<!-- _class: split-metric accent -->
<!-- _footer: "Composition: accent · split-metric accent" -->
