...
<!-- _footer: "Mirror — panel on the right · split-panel mirror" -->
...
- `split-statement` — thesis + one big-number — quantitative version of split-panel
