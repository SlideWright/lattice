...
- `actors` — rules attach to named owners, not shared tenets
- `tldr` — single-line takeaways without justification body
- `list` — items are short bullets without title + body shape
- `cards-stack` — each principle needs two sentences of body
