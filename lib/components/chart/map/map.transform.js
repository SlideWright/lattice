 ...
 * world basemap; `us` (or nothing) is the default. Forward-compatible — a new
 * basemap is one more token + one more required JSON.
 */
function pickBasemap(classTokens) {
  return Array.isArray(classTokens) && classTokens.includes('world') ? WORLD_BASEMAP : US_BASEMAP;
}
...
module.exports = {
  ...
  regionIndex, groupIndex, BASEMAP, US_BASEMAP, WORLD_BASEMAP, MIX_FLOOR, MIX_CEIL,
};
