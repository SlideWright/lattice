...
// Charts cycle the dedicated --chart-1..8 ramp (data-ink, optimised for
// 8-way series separation). Defaults to var(--cN-dark) in base.tokens.css,
// so themes without a curated ramp render unchanged. See palette-recuration §7.
const PIE_PALETTE = [
