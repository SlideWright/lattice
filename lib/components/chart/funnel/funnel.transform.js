...
const GEOM = {
  ...
  top: 16,
  bottom: 172,
  cx: 188, // funnel centre — bands flanked by labels (left) and values (right)
  fullW: 150, // widest band spans cx ± fullW/2  → x 113 … 263
  labelX: 104, // right edge of the left-hand label column (text-anchor end)
  valueX: 272, // left edge of the right-hand value column (text-anchor start)
