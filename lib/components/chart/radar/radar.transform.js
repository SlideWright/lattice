...
const RADAR_PALETTE = [
  'light-dark(var(--c1-dark), var(--c1-light))', 'light-dark(var(--c2-dark), var(--c2-light))',
  'light-dark(var(--c3-dark), var(--c3-light))', 'light-dark(var(--c4-dark), var(--c4-light))',
  'light-dark(var(--c5-dark), var(--c5-light))', 'light-dark(var(--c6-dark), var(--c6-light))',
  'light-dark(var(--c7-dark), var(--c7-light))', 'light-dark(var(--c8-dark), var(--c8-light))',
];
