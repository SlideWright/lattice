 ...
 *   - Two substance-defined exceptions: `chart` (series substance) and
 *     `diagram` (graph substance) — colocates components sharing a
 *     renderer kernel + palette-injection pipeline.
