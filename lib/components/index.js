 ...
 *
 * The seven function families plus two substance-defined exceptions
 * (`chart` covers series-substance components, `diagram` covers
 * graph-substance components). For 49 of the 58 shipped components
 * `bucket === function`; for the 9 chart/diagram components the
 * manifest declares the bucket explicitly to colocate the maintenance
 * surface. The audience-function taxonomy in design-system.md §3 is
 * preserved — see §9 for the disk-vs-function rationale.
 */
