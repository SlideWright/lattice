 ...
 *   - Three substance-defined exceptions: `chart` (series substance,
 *     internal SVG kernel), `diagram` (graph substance, Mermaid), and
 *     `math` (prose substance, KaTeX). Each colocates components built
 *     around a specific rendering pipeline.
