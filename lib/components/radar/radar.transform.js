...
// cycle (piechart in lib/chart-family/chart-family.js — PIE_PALETTE; journey
...
// Series colours read --cN-light (recessive register): pale on light
// canvas, deep saturated on dark canvas. Same lightness rung as mermaid
// bands, pie wedges, progress bars — keeps the chart family unified.
// Pre-2026-05-17 this read --cN-dark which inverted (pale on dark =
// invisible polygons against the dark canvas).
const RADAR_PALETTE = [
