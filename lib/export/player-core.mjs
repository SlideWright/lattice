...
export async function assemblePlayer(data, caps) {
	...
	const js = await playerJs(hasScene ? ANIMA_PLAYER_JS : '', hasNarration ? beats : null, hasCaptions, canvas, hasChart ? { js: ANIMA_CHART_JS, deck: chartMotion } : null, lensViews, lensDefault);
