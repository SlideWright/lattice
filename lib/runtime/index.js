...
// the meta / progress DOM mirrors (lib/runtime/form-dom.js).
const formDom = require('./form-dom');
// The watermark Tile owns BOTH its adapters (HTML-string + DOM) in one
// self-contained kernel (lib/forms/tile/watermark) — issue #356.
...
(() => {
  ...
  function startOverflowWatcher() {
    ...
    const TOL = 12;
    // Overflow is detected at the SLIDE level (content exceeds the 1280×720
