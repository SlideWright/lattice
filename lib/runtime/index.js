...
(() => {
  ...
  function buildMermaidThemeVars() {
    ...
    const result = {
      ...
      // Pie chart — the dedicated --chart-N ramp, matching chart-family pies
      // (charts share one ramp across both engines; diagram node fills stay
      // pale --cN-light). See palette-recuration: cohesion by object type.
      pie1:  vc('chart-1'),  pie2:  vc('chart-2'),
      pie3:  vc('chart-3'),  pie4:  vc('chart-4'),
      pie5:  vc('chart-5'),  pie6:  vc('chart-6'),
      pie7:  vc('chart-7'),  pie8:  vc('chart-8'),
      pie9:  vc('chart-1'),  pie10: vc('chart-2'),
      pie11: vc('chart-3'),  pie12: vc('chart-4'),
      ...
      xyChart: {
        ...
        plotColorPalette: [
          vc('chart-1'), vc('chart-2'), vc('chart-3'), vc('chart-4'),
          vc('chart-5'), vc('chart-6'), vc('chart-7'), vc('chart-8'),
        ].join(','),
      },
