...
// `\s*` (not `\s+`): minified palettes ship the import as `@import"concrete"`
// with no space — requiring whitespace collapsed every `*-dark` wrapper to
// scaffold-only CSS. See THEME_IMPORT_RE in css.js for the same fix.
