...
function createEngine(opts = {}) {
  ...
  function buildMd(globalBase) {
    ...
    if (opts.math !== false) installMath(md);
  ...
  function renderHtml(body, globalBase, source) {
    ...
    // HTML-stage transforms — identical to marp.config.js / playground wrapper.
  ...
  function render(markdown, theme) {
    ...
    const css = themes.cssFor(globalBase.theme || directives.theme || 'lattice');
    return { html, css };
  }
