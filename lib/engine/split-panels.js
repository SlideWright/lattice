/**
 * Split-panel DOM transform — HTML string rewrite for the five split-panel
 * layouts: split-brief, split-metric, split-steps, split-compare,
 * split-statement.
 *
 ...
 * split-panel slides in place. Non-split sections pass through unchanged.
 */
