...
/**
 * Front-matter reader for the Form `meta:` directive (the meta Tile,
 * design/forms.md §8). One deck-wide string, ` | ` to split into stacked lines.
...
/**
 * HTML-stage helper: the progress Tile. Derives sections from
...
/**
 * HTML-stage helper: the watermark Tile. On any `form
