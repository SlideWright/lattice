...
function headingSplit(markdown) {
  ...
  const isEyebrowInline = (t) => t && t.type === 'inline' && Array.isArray(t.children)
    && t.children.some((c) => c.type === 'code_inline')
    && t.children.every((c) => c.type === 'code_inline' || c.type === 'softbreak' || (c.type === 'text' && c.content.trim() === ''));
