...
function slotLabelLift(markdown) {
  ...
  // word boundary).
  const SLOT_LAYOUTS =
    /(?<![\w-])(compare-prose|before-after|decision|split-brief|split-metric|split-steps|split-compare|split-statement|statute-stack|regulatory-update|authority-chain|redline|timeline|list-criteria|actors)(?![\w-])/;
