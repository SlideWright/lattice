...
// `backdrop` / `backdrop-blueprint` / `backdrop-none`) are too many to enumerate
// and not author-misspellable in a way worth flagging. (The deck-wide `finish:`
// register that maps to backdrop classes is linted separately via finishNames.)
const MODIFIER_PREFIXES = ['tint-', 'mark-', 'with-', 'at-', 'no-', 'tone-', 'treatment-', 'checks-', 'fill-', 'backdrop'];
