 ...
 * `..`, but ONLY inside the line's inline-code spans (the task pills) so prose in
 * the label is never touched. Returns the rewritten line, or null if there's no
 * retired delimiter inside a code span to change.
 */
