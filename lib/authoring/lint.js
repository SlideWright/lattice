...
function buildVocab(manifests) {
  ...
  const universalModifiers = new Set([...BASE_MODIFIERS, ...FRAME_MODIFIERS, ...SEMI_UNIVERSAL_VARIANTS]);
  ...
  return { names, modifiers, universalModifiers, capacity, mapRegions: buildMapVocab(), finishNames: [...FINISH_NAMES], modeNames: [...MODE_NAMES], splitNames: [...SPLIT_NAMES] };
}
