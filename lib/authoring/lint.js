 ...
 * `{ names: Set, modifiers: Set, universalModifiers: Set, mapRegions }` — a
 * superset of the `{ names, modifiers }` shape lintTextWith consumes.
 */
function buildVocab(manifests) {
  ...
  return { names, modifiers, universalModifiers, mapRegions: buildMapVocab() };
}
