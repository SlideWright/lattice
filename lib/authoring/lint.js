...
// `with-period`, `no-footer`, `tone-pass`, `treatment-none`) are too many to
// enumerate and are not author-misspellable in a way worth flagging.
const MODIFIER_PREFIXES = ['tint-', 'mark-', 'with-', 'at-', 'no-', 'tone-', 'treatment-'];
...
const BASE_MODIFIERS = ['mirror', 'left', 'numbered', 'heat', 'overflow', 'briefing', 'horizontal'];
