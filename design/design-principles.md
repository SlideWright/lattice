...
- See `engineering/typography.md` for the full 11-token contract
...
/* Pagination — single mechanism across both rendering paths.
   The Marp CLI engine emits `data-lattice-pagination="N"` on each <section>;
