...
| `chart`      | 12    | substance = data visualizations (function stays evidence/progression); journey + word-cloud folded into the chart family |
...
For 32 of the 53 components `bucket === function`. The 21 divergent
