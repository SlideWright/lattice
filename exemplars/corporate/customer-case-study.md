...
theme: indaco
paginate: true
header: "Atlas Robotics · Pinewood case study"
---
...
1. 190
   - Units per day
   - up from 80 `2.4× output` `Measured`
2. 4 wk
   - Order lead time
   - down from 12 `−67%` `Verified`
3. +44%
   - Revenue YoY
   - on filled backlog `12-mo` `Audited`
...
2. $1.9M
   - Year-one savings
   - labor + scrap + rework `Measured` `Ops`
3. 31%
   - Cost per unit cut
   - sustained at scale `12-mo` `Audited`
