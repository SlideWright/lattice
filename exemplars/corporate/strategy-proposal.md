...
theme: indaco
paginate: true
header: "Verdara · Strategy proposal"
---
...
- 38%
  - landed-cost penalty on every European order shipped from North America — turning a healthy margin into a loss.
...
1. €18M
   - EU revenue
   - from $0 today `FY2028` `Board`
2. 26%
   - Blended gross margin
   - vs −7% exporting `FY2028` `Finance`
3. 51%
   - Verdara JV stake
   - controlling interest `Governance` `Legal`
...
| Workstream | Now `H2 2026` | Build `H1 2027` | Scale `H2 2027` |
| --- | --- | --- | --- |
| Partner | [x] Shortlist of 3 | [-] Term sheet signed | [ ] JV operational |
| Production | [ ] Line audit | [-] Tooling transfer | [ ] First shipment |
| Commercial | [x] Pipeline mapped | [-] Anchor accounts | [ ] EU sales team |
...
## Europe is asking — let's build the door in.

`Sofia Lindqvist · Chief Strategy Officer · strategy@verdara.example`
