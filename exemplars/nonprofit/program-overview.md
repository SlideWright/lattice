...
theme: indaco
paginate: true
header: "GreenRoots Youth Corps · Program overview"
---
...
```mermaid
flowchart LR
  A["Recruit youth"] --> B["Paid training"]
  B --> C["Restoration projects"]
  C --> D{"Credential earned"}
  D -->|"yes"| E["Job placement"]
  D -->|"no"| F["Extended mentorship"]
  F --> C
```
