...
- Write `engineering/typography.md`: the 10 tokens, each role, sizing rationale, author rules, HTML-element mapping
...
- Update `engineering/design-system.md` typography section
