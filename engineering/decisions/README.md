...
- ☐ [2026-06-18-component-adaptive-sizing.md](2026-06-18-component-adaptive-sizing.md) — Make components adaptive to the box they occupy (not the deck's named size) via box-local @container queries over four structural families — Wide · Square · Tall · Strip
