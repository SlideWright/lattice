...
- ☐ [2026-06-18-frame-recursion-cells.md](2026-06-18-frame-recursion-cells.md) — The Cell-holds-Frame recursion is declared in the schema but never executed; what a real `framed` frame would do, and the heading/label-carrier grammar it forces (subtitle moves to literal italic-after-title)
...
_109 notes — 48 active, 58 shipped (pending teardown), 3 historical. Generated by `npm run decisions:index`; edit a note's front-matter, not this list._
