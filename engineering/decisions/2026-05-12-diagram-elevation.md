...
5. **Document the rule** in `design/theming.md` next to the band
   taxonomy. One paragraph + the proposed-rule blockquote above.

6. **Add to `engineering/gotchas.md`.** Symptom: "Timeline events
...
- `design/theming.md` scope narrowed: card-on-band documented as
...
- `engineering/gotchas.md` entry rewritten as a *trap* warning
...
- `design/theming.md` — "Pale band, L≈90" updated to "Tinted band, L≈83";
