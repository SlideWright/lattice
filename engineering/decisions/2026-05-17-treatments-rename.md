...
>
> Documented in `engineering/gotchas.md` → "Chromium PDF output of CSS
> `mask-image` renders inconsistently across viewers" and in
> `engineering/treatments.md` → "Mark rendering".
...
- `engineering/backgrounds.md` → `engineering/treatments.md`
...
5. `engineering/treatments.md` (new file, replaces `backgrounds.md`).
6. `design/skill.md`, `design/design-system.md` swept.
...
10. `engineering/gotchas.md` entry pointing to this note as the
