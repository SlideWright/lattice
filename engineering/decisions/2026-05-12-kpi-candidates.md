...
size: hd
paginate: true
header: "Lattice · KPI system · v1"
---

<!-- _class: title -->
<!-- _paginate: false -->
<!-- _footer: "KPI system · v1" -->

# Executive KPI system

`2026-05-12`

One cohesive `kpi` base, five layout modifiers. The bare class
defaults to **briefing** (hero + supports). All five share the same
type, pills, eyebrow, and ✦ flagship ornament.

---

<!-- _class: kpi -->
<!-- _header: '' -->
<!-- _footer: "kpi (bare) — defaults to briefing" -->
