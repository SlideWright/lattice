...
// src/runtime/index.js); it's regenerated by npm run runtime:build and
...
// changes under src/runtime/** trigger the bundle rebuild AND the
...
function isSkippable(rel) {
  return rel.startsWith('docs/')
      ...
      // hook. Tests of its sources fire via src/runtime/** below.
...
for (const f of process.argv.slice(2)) {
  ...
  // src/runtime/* — runtime source bundled into lattice-runtime.js.
  // Tests of the bundled DOM transforms live in test:transformers.
  if (rel.startsWith('src/runtime/') && rel.endsWith('.js')) {
    scripts.add('test:transformers');
    continue;
  }
