...
- Write `reference/engineering/typography.md`: the 10 tokens, each role, sizing rationale, author rules, HTML-element mapping
...
- Update `reference/engineering/design-system.md` typography section
