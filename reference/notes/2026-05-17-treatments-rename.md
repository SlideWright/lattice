...
>
> Documented in `reference/engineering/gotchas.md` → "Chromium PDF output of CSS
> `mask-image` renders inconsistently across viewers" and in
> `reference/engineering/treatments.md` → "Mark rendering".
...
- `reference/engineering/backgrounds.md` → `reference/engineering/treatments.md`
...
5. `reference/engineering/treatments.md` (new file, replaces `backgrounds.md`).
6. `reference/skill.md`, `reference/design-system.md` swept.
...
10. `reference/engineering/gotchas.md` entry pointing to this note as the
