...
- Documentation: `CLAUDE.md`, `README.md`, `reference/architecture.md`,
  `reference/design-system.md`, `reference/engineering/audit.md`, `lib/base/base.docs.md`
...
- `reference/notes/2026-05-04-authoring-proposals.md` — dated snapshot from
  before the rename; the proposals discussed there reference
  `split-panel` because that was the name at proposal time
- `reference/notes/2026-05-11-4k-rendering-audit.md` — dated audit snapshot
...
- `marp.config.js` / `lattice-runtime.js` / `reference/engineering/gotchas.md`
  — references to `lib/engine/split-panels.js` (the file above)

## Related deferred work

- `split-list` `chapter` and `metrics` variants from
  `reference/notes/2026-05-04-authoring-proposals.md` (proposed but never
