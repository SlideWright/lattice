...
> the canonical rules into `reference/engineering/templates.md` and delete
> this note.
...
- See `reference/engineering/gotchas.md → "Marp Core wraps emoji in
...
`reference/engineering/templates.md`).
