...
That block is what a `reference/skill.md` entry, a snippet, and a linter rule all read from. Today it lives implicitly in CSS comments and prose. Making it explicit (Part 4 below) is what turns Lattice from "a theme with conventions" into "a slide component library."
...
- The `reference/skill.md` authoring tables (auto-rendered).
