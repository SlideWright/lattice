...
- `reference/skill.md`, `reference/engineering/templates.md`,
  `reference/engineering/design.md`, `reference/engineering/mermaid.md`,
  `reference/editorial.md`, `reference/theming.md`
...
- **H10 — doc-drift.** *(continuous)* CI check that
  ...
  `reference/engineering/templates.md` and vice versa, and that
