...
[reference/engineering/templates.md](../references/templates.md) follows a single
canonical geometry:
...
1. **Read first.** `python3 tools/ascii-preview.py audit reference/engineering/templates.md`
