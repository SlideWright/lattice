...
See `reference/notes/2026-05-12-diagram-tokens.md` for the architectural
...
Audit and design rationale: `reference/notes/2026-05-12-diagram-elevation.md`.
...
- **Diagram titles (all types)** — Mermaid renders its own `title`
  ...
  timeline, xy-chart) and remain visible — see reference/engineering/mermaid.md
