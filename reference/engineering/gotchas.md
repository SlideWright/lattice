...
spin out a `reference/notes/YYYY-MM-DD-topic.md` and link to it from here.
...
- **Commits:** This branch (treatments rename; the cropped-bbox + box-shadow + gradient-slot escape hatches). See `reference/engineering/treatments.md` → "Mark rendering" for the rendering-mechanism breakdown.
...
- **Mitigation:** The cat-* tokens in [themes/indaco.css:286-294](../../themes/indaco.css#L286-L294)
  ...
  [reference/engineering/mermaid.md](./mermaid.md).
...
- **Commits:** Initial misapplication + audit + revert; see
  `reference/notes/2026-05-12-diagram-elevation.md`.
...
- **See:** `reference/notes/2026-05-12-diagram-tokens.md`.
...
- **Mitigation:** Mermaid is now vendored at the repo root as
  ...
  [reference/notes/2026-04-30-mermaid-theming.md](../notes/2026-04-30-mermaid-theming.md)
...
- **Commits:** Radar feature commit; see
  [reference/notes/2026-05-15-radar-chart.md](../notes/2026-05-15-radar-chart.md).
...
- **Mitigation:** Replace per the migration map in
  `reference/notes/2026-05-19-typography-token-refactor.md` §6 and the
