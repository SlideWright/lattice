...
The four axes are mutually **orthogonal** — swap one and the others hold. The structural spine is **containment and selection**: a **Frame** carves the slide into **Cells**, and each **Cell** holds a **Tile** — the seam between a slicer and what fills it is what makes this a lattice rather than a flat list.
