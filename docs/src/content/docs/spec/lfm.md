...
description: "The normative specification for Lattice-Flavored Markdown: the extension set over CommonMark + GFM, how each construct degrades, and what makes a document conformant."
---

<!-- GENERATED by tools/build-spec-docs.js from spec/LFM-1.0.md — do not edit; edit the spec. -->

:::note[Canonical source]
This page is generated from [`spec/LFM-1.0.md`](https://github.com/slidewright/lattice/blob/main/spec/LFM-1.0.md) and published under [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/). New to LFM? Start with [Understanding LFM](/spec/understanding-lfm/).
:::
...
[Lattice](/overview/) slide engine. Its name follows *GitHub-Flavored
...
| **L2** | *Lattice-diagnostic* | The tool additionally implements the [Diagnostic Protocol](/spec/diagnostics/): it validates a document, reports findings with stable rule IDs, and offers machine-applicable fixes. |
...
[`dist/docs/grammar.json`](https://github.com/slidewright/lattice/blob/main/dist/docs/grammar.json), generated from the
component manifests.
...
published in [`dist/docs/grammar.json`](https://github.com/slidewright/lattice/blob/main/dist/docs/grammar.json)). The
canonical shape is:
...
own its schema. [`dist/docs/grammar.json`](https://github.com/slidewright/lattice/blob/main/dist/docs/grammar.json) records
...
- **L1 (structure).** A fixture pairs an LFM document with the components and
  ...
  [`dist/docs/grammar.json`](https://github.com/slidewright/lattice/blob/main/dist/docs/grammar.json) is the oracle.
