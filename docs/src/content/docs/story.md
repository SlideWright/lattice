...
The same blank canvas. The same master slide everything inherits from,
until the first override sends the whole deck drifting. They make authors
...
**Lattice is the answer I wanted to exist:** a deck as a text file, with
the discipline of a design system and taste built into the engine instead
