import { FileText, Palette, PencilRuler, Play, Share2, Sparkles } from 'lucide-react';
...
export function CommandPalette({
	open, onOpenChange, decks, palettes, onPickDeck, onPalette, onPresent, onShare, onFabricate, onReshape,
}: {
	open: boolean;
