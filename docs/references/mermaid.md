...
1. Add a `title` directive to the diagram in `lib/integrations/mermaid/mermaid.gallery.md`.
2. Build to HTML via `node lattice-emulator.js lib/integrations/mermaid/mermaid.gallery.md ...`.
