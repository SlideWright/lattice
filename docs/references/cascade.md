...
`docs/notes/2026-05-18-important-audit-phase-35-prep.md` but has no
near-term action.
...
`docs/notes/2026-05-18-important-audit-phase-35-prep.md` has the full
breakdown. Summary:
...
- `docs/notes/2026-05-18-important-audit-phase-35-prep.md` —
  the full audit; categorization of every `!important` declaration
- `docs/notes/2026-05-18-component-reorg-and-modular-css.md` —
  the broader refactor plan that surfaced this
- `docs/design-system.md` §10 (CSS architecture) — high-level
  bundling intent
- `docs/references/gotchas.md` — VS Code PDF preview and other
