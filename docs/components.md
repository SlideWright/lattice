...
**58 components · 12 buckets.** For the themable, browsable edition see [components.html](./components.html).
...
This layout accepts all universal variants (`dark`, `compact`, `loose`, `accent`, state markers, treatments). See [docs/design-system.md §6.5](./design-system.md#65-universal-variants--three-tiers) for the catalog.
