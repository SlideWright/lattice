...
[Markdown document](https://github.com/slidewright/lattice/blob/main/docs/components.md).
...
- [Component reference](/lattice/components.html) — every layout's
  authoring contract.
- [`docs/skill.md`](https://github.com/slidewright/lattice/blob/main/docs/skill.md)
